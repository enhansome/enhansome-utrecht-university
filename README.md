...
* [parcels](https://github.com/OceanParcels/parcels) ⭐ 361 | 🐛 120 | 🌐 Python | 📅 2026-09-07 - Main code for Parcels (Probably A Really Computationally Efficient Lagrangian Simulator)
* [PCRaster](https://github.com/pcraster/pcraster) ⭐ 99 | 🐛 84 | 🌐 C++ | 📅 2026-09-07 - Environmental modeling software
...
* [Virtual Ship](https://github.com/OceanParcels/virtualship) ⭐ 13 | 🐛 37 | 🌐 Python | 📅 2026-09-07 - a simulator allowing students to plan and conduct a virtual research expedition, receiving measurements as if they were coming from actual oceanographic instruments
...
"Awesome lists" are curated lists of awesome stuff. The lists are very popular in the field of open source development (see <https://github.com/sindresorhus/awesome> ⭐ 503,967 | 🐛 106 | 📅 2026-09-02). Read ["The awesome manifesto"](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 503,967 | 🐛 106 | 📅 2026-09-02 for more information about awesome lists.
