...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 496,105 | 🐛 100 | 📅 2026-06-30
...
* [PCR-GLOBWB\_model](https://github.com/UU-Hydro/PCR-GLOBWB_model) ⭐ 147 | 🐛 23 | 🌐 Python | 📅 2026-08-06 - PCR-GLOBWB (PCRaster Global Water Balance) is a large-scale hydrological model intended for global to regional studies and developed at the Department of Physical Geography.
...
* [asreview](https://github.com/asreview/asreview) ⭐ 972 | 🐛 116 | 🌐 Python | 📅 2026-08-10 - Active learning for systematic reviews
...
* [parcels](https://github.com/OceanParcels/parcels) ⭐ 357 | 🐛 138 | 🌐 Python | 📅 2026-08-14 - Main code for Parcels (Probably A Really Computationally Efficient Lagrangian Simulator)
...
* [iBridges](https://github.com/UtrechtUniversity/iBridges) ⭐ 21 | 🐛 9 | 🌐 Python | 📅 2026-08-14 - Python API and commandline interface to easily interact with Yoda and iRODS servers
...
* [Virtual Ship](https://github.com/OceanParcels/virtualship) ⭐ 13 | 🐛 34 | 🌐 Python | 📅 2026-08-14 - a simulator allowing students to plan and conduct a virtual research expedition, receiving measurements as if they were coming from actual oceanographic instruments
...
"Awesome lists" are curated lists of awesome stuff. The lists are very popular in the field of open source development (see <https://github.com/sindresorhus/awesome> ⭐ 496,105 | 🐛 100 | 📅 2026-06-30). Read ["The awesome manifesto"](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 496,105 | 🐛 100 | 📅 2026-06-30 for more information about awesome lists.
