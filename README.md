...
* [asreview](https://github.com/asreview/asreview) ⭐ 1,000 | 🐛 112 | 🌐 Python | 📅 2026-08-31 - Active learning for systematic reviews
...
* [parcels](https://github.com/OceanParcels/parcels) ⭐ 360 | 🐛 125 | 🌐 Python | 📅 2026-09-01 - Main code for Parcels (Probably A Really Computationally Efficient Lagrangian Simulator)
...
* [iBridges](https://github.com/UtrechtUniversity/iBridges) ⭐ 21 | 🐛 10 | 🌐 Python | 📅 2026-08-28 - Python API and commandline interface to easily interact with Yoda and iRODS servers
...
* [LUE](https://github.com/computationalgeography/lue) ⭐ 17 | 🐛 245 | 🌐 C++ | 📅 2026-08-20 - Modelling framework for simulating large geographical systems of agents and fields
...
* [Virtual Ship](https://github.com/OceanParcels/virtualship) ⭐ 13 | 🐛 37 | 🌐 Python | 📅 2026-09-01 - a simulator allowing students to plan and conduct a virtual research expedition, receiving measurements as if they were coming from actual oceanographic instruments
...
"Awesome lists" are curated lists of awesome stuff. The lists are very popular in the field of open source development (see <https://github.com/sindresorhus/awesome> ⭐ 502,035 | 🐛 105 | 📅 2026-08-21). Read ["The awesome manifesto"](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 502,035 | 🐛 105 | 📅 2026-08-21 for more information about awesome lists.
