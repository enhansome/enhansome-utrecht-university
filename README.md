...
* [parcels](https://github.com/OceanParcels/parcels) ⭐ 357 | 🐛 136 | 🌐 Python | 📅 2026-08-13 - Main code for Parcels (Probably A Really Computationally Efficient Lagrangian Simulator)
...
* [LUE](https://github.com/computationalgeography/lue) ⭐ 17 | 🐛 248 | 🌐 C++ | 📅 2026-08-13 - Modelling framework for simulating large geographical systems of agents and fields
...
* [Virtual Ship](https://github.com/OceanParcels/virtualship) ⭐ 13 | 🐛 33 | 🌐 Python | 📅 2026-08-13 - a simulator allowing students to plan and conduct a virtual research expedition, receiving measurements as if they were coming from actual oceanographic instruments
...
"Awesome lists" are curated lists of awesome stuff. The lists are very popular in the field of open source development (see <https://github.com/sindresorhus/awesome> ⭐ 495,361 | 🐛 99 | 📅 2026-06-30). Read ["The awesome manifesto"](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 495,361 | 🐛 99 | 📅 2026-06-30 for more information about awesome lists.
